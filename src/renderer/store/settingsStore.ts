...
const translations = {
  en: {
    ...
    workspaceSaved: 'Workspace saved to history',
    ...
    saveWorkspaceDescription: 'Save the current workbench to history',
    ...
    sessionHistoryDescription: 'Restore saved workspaces or open terminal logs.',
    savedWorkspaces: 'Saved Workspaces',
    noSavedWorkspaces: 'No saved workspaces yet.',
    restoreWorkspace: 'Restore Workspace',
    restoreWorkspaceConfirm: 'Restore this workspace? Current terminals will be closed.',
  ...
  'zh-CN': {
    ...
    saveWorkspaceDescription: '将当前工作台保存到历史',
    ...
    sessionHistory: '历史',
    sessionHistoryDescription: '还原已保存的工作台，或打开终端日志。',
    savedWorkspaces: '历史工作台',
    noSavedWorkspaces: '暂无已保存工作台。',
    restoreWorkspace: '还原工作台',
    restoreWorkspaceConfirm: '确定还原这个工作台吗？当前终端会被关闭。',
  ...
  'zh-TW': {
    ...
    saveWorkspaceDescription: '將目前工作台儲存到歷史',
    ...
    sessionHistory: '歷史',
    sessionHistoryDescription: '還原已儲存的工作台，或開啟終端日誌。',
    savedWorkspaces: '歷史工作台',
    noSavedWorkspaces: '暫無已儲存工作台。',
    restoreWorkspace: '還原工作台',
    restoreWorkspaceConfirm: '確定還原這個工作台嗎？目前終端會被關閉。',
    terminalCount: '{count} 個終端',
    terminalLogs: '終端日誌',
    noLogs: '暫無日誌。',
    taskBoard: '任務看板',
